...
export default function HomePage(){
 const [posts,setPosts]=useState<Post[]>([]);const [requests,setRequests]=useState<RequestItem[]>([]);const [composer,setComposer]=useState<'status'|'request'|null>(null);const [answerId,setAnswerId]=useState<string|null>(null);const [query,setQuery]=useState('');const [toast,setToast]=useState('');const [tab,setTab]=useState<'home'|'requests'|'groups'|'map'>('home');const [profile,setProfile]=useState(false);const [location,setLocation]=useState<Loc|null>(null)
